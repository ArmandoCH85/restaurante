...
@section('content')
    @if(isset($tableId) && isset($orderId))
        <livewire:pos.point-of-sale :tableId="$tableId" :orderId="$orderId" :preserveCart="$preserveCart ?? false" :invoice="$invoice ?? false" />
    @elseif(isset($tableId))
        <livewire:pos.point-of-sale :tableId="$tableId" />
    @elseif(isset($orderId))
        <livewire:pos.point-of-sale :orderId="$orderId" :preserveCart="$preserveCart ?? false" :invoice="$invoice ?? false" />
