...
{
    public function __construct(private readonly ProductsByChannelProfitService $profitService) {}
    ...
    public function download(Request $request)
    {
        try {
            ...
            Log::info('🔍 Construyendo query de ganancia por canal basada en invoices');
            $productsData = $this->profitService->getByChannel(
            ...
            $sheet->setCellValue('C5', 'Ganancia (S/)');
            ...
            foreach ($productsData as $channelData) {
                ...
                // Ganancia
                $sheet->setCellValue('C'.$row, number_format($channelData->total_profit, 2));
            ...
            $totalProfit = $productsData->sum('total_profit');
            ...
            $filename = 'ganancia_por_canal_'.date('Y-m-d_H-i-s').'.xlsx';
