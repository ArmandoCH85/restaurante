        ...
        try {
            ...
            if ($newStatus === 'in_transit') {
                ...
                if ($isDeliveryPerson) {
                    ...
                    return redirect()->back()->with('error', 'No tienes permiso para cambiar el estado a En Tránsito');
                }
            } else if ($newStatus === 'delivered') {
                // Solo Admin, Super Admin o Cashier pueden marcar como entregado
                if (!$isAdmin) {
                    return redirect()->back()->with('error', 'Solo administradores y cajeros pueden finalizar pedidos de delivery');
                }
            }
